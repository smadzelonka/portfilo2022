...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="/SeanMadzelonkaDevOpsResume.pdf"
        variant="secondary"
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[one, two, three, four, five].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Sean Madzelonka - Software designer, amateur astronaut, and travel
          enthusiast
        </title>
        <meta
          name="description"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software designer, amateur astronaut, and travel enthusiast.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Sean, a software designer and entrepreneur based in Dallas,
            Texas. Looking for opportunities, where we develop technologies that
            empower regular people to explore and develop on their own terms.
          </p>
